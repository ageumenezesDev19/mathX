...
<body>
    ...
    @if ($errors->any())
        <div class="container">
            <div class="row">
                <div class="alert alert-danger text-center mt-3 d-flex justify-content-around align-items-center">
                    Por favor selecione pelo menos uma operação.
                    As parcelas devem ser números entre 0 e 999.
                    O número de exercícios devem variar entre 5 e 50.
                    <button type="button" class="close d-flex align-items-center justify-content-center" data-bs-dismiss="alert" aria-label="Close">
